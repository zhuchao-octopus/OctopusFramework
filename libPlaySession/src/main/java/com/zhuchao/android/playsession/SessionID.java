...
public class SessionID {
    ...
    //板块分类视频列表的ID
    public static final int SESSION_TYPE_GET_MOVIELIST_ALLTV = 2003;//30;//获取直播/电视列表
    public static final int SESSION_TYPE_GET_MOVIELIST_ALLMOVIE = 2004;//SESSION_TYPE_GET_MOVIELIST_ALLTV+1;//电影
    public static final int SESSION_TYPE_GET_MOVIELIST_ALLMOVIE2 = 2005;//SESSION_TYPE_GET_MOVIELIST_ALLMOVIE+1;//电视剧

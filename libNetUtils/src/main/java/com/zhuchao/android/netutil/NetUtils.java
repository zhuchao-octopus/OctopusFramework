...
public class NetUtils {
    ...
    public NetUtils setNetChangedCallBack(NetChangedCallBack mNetChangedCallBack) {
        this.netChangedCallBack = mNetChangedCallBack;
        return this;
    }
    ...
    private synchronized void updateNetStatus() {
        ...
        if (netChangedCallBack != null) {
            netChangedCallBack.onNetStateChanged(NetStatus, NetType, MAC, WMAC, IP0, IP1, Location);
        }
    }
    ...
    private synchronized void updateWiFiStrength() {
        ...
        if (wifiInfo != null && wifiInfo.getBSSID() != null) {
            ...
            if (netChangedCallBack != null) {
                netChangedCallBack.onWifiLevelChanged(WifiLevel);
            }
        }
    }

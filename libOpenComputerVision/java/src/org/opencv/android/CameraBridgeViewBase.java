...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    protected int mCameraType = CAMERA_ID_ANY;
    protected int mCameraIndex = 0;
    ...
    public CameraBridgeViewBase(Context context, AttributeSet attrs) {
        ...
        mCameraType = styledAttrs.getInt(R.styleable.CameraBridgeViewBase_camera_id, -1);
        mCameraIndex = styledAttrs.getInt(R.styleable.CameraBridgeViewBase_camera_index, 0);

...
public class JavaCamera2View extends CameraBridgeViewBase {
        ...
        try {
            ...
            if (mCameraType == CameraBridgeViewBase.CAMERA_ID_ANY) {
                ...
                for (String cameraID : camList) {
                    ...
                    if ((mCameraType == CameraBridgeViewBase.CAMERA_ID_BACK && characteristics.get(CameraCharacteristics.LENS_FACING) == CameraCharacteristics.LENS_FACING_BACK) || (mCameraType == CameraBridgeViewBase.CAMERA_ID_FRONT && characteristics.get(CameraCharacteristics.LENS_FACING) == CameraCharacteristics.LENS_FACING_FRONT)) {
                        mCameraID = cameraID;
                        break;
                    }
                }
    ...
    boolean calcPreviewSize(final int width, final int height) {
        ...
        try {
            ...
            if (mPreviewSize.getWidth() == frameSize.width && mPreviewSize.getHeight() == frameSize.height) return false;
            else {

...
public final class CvType {
    ...
    public static final int makeType(int depth, int channels) {
        ...
        if (depth < 0 || depth >= CV_DEPTH_MAX) {
            throw new UnsupportedOperationException("Data type depth should be 0.." + (CV_DEPTH_MAX - 1));
        }

...
public class Calib3d {
    ...
    public static final int CALIB_ROBOT_WORLD_HAND_EYE_SHAH = 0, CALIB_ROBOT_WORLD_HAND_EYE_LI = 1;


    // C++: enum SamplingMethod (cv.SamplingMethod)
    public static final int SAMPLING_UNIFORM = 0, SAMPLING_PROGRESSIVE_NAPSAC = 1, SAMPLING_NAPSAC = 2, SAMPLING_PROSAC = 3;
    ...
    public static final int SOLVEPNP_ITERATIVE = 0, SOLVEPNP_EPNP = 1, SOLVEPNP_P3P = 2, SOLVEPNP_DLS = 3, SOLVEPNP_UPNP = 4, SOLVEPNP_AP3P = 5, SOLVEPNP_IPPE = 6, SOLVEPNP_IPPE_SQUARE = 7, SOLVEPNP_SQPNP = 8, SOLVEPNP_MAX_COUNT = 8 + 1;

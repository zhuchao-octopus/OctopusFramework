...
// 16 >> 32
    inline v_int32x4 v_dotprod(const v_int16x8 &a, const v_int16x8 &b) { return v_int32x4(msa_dotp_s_w(a.val, b.val)); }

    inline v_int32x4 v_dotprod(const v_int16x8 &a, const v_int16x8 &b, const v_int32x4 &c) { return v_int32x4(msa_dpadd_s_w(c.val, a.val, b.val)); }

// 32 >> 64
    inline v_int64x2 v_dotprod(const v_int32x4 &a, const v_int32x4 &b) { return v_int64x2(msa_dotp_s_d(a.val, b.val)); }

    inline v_int64x2 v_dotprod(const v_int32x4 &a, const v_int32x4 &b, const v_int64x2 &c) { return v_int64x2(msa_dpadd_s_d(c.val, a.val, b.val)); }
...
{ return _Tpvec(MSA_TPV_REINTERPRET(_Tpv, msa_cgeq_##suffix(a.val, b.val))); }
    ...
    inline v_float32x4 v_not_nan(const v_float32x4 &a) { return v_float32x4(MSA_TPV_REINTERPRET(v4f32, msa_ceqq_f32(a.val, a.val))); }

    inline v_float64x2 v_not_nan(const v_float64x2 &a) { return v_float64x2(MSA_TPV_REINTERPRET(v2f64, msa_ceqq_f64(a.val, a.val))); }
...
/** Reverse **/
    inline v_uint8x16 v_reverse(const v_uint8x16 &a) {
        v_uint8x16 c = v_uint8x16(
                (v16u8) __builtin_msa_vshf_b((v16i8)((v2i64) {0x08090A0B0C0D0E0F, 0x0001020304050607}), msa_dupq_n_s8(0), (v16i8) a.val));
        return c;
    }
    ...
    inline v_uint16x8 v_reverse(const v_uint16x8 &a) {
        v_uint16x8 c = v_uint16x8(
                (v8u16) __builtin_msa_vshf_h((v8i16)((v2i64) {0x0004000500060007, 0x0000000100020003}), msa_dupq_n_s16(0), (v8i16) a.val));
        return c;
    }
...
{ \
    ...
    inline uint64 v_reduce_sum(const v_uint64x2 &a) { return (uint64)(msa_getq_lane_u64(a.val, 0) + msa_getq_lane_u64(a.val, 1)); }

    inline int64 v_reduce_sum(const v_int64x2 &a) { return (int64)(msa_getq_lane_s64(a.val, 0) + msa_getq_lane_s64(a.val, 1)); }
...
/* v_round, v_floor, v_ceil, v_trunc */
    ...
    inline v_int32x4 v_floor(const v_float64x2 &a) {
        ...
        return v_int32x4(
                msa_pack_s64(msa_addq_s64(msa_cvttruncq_s64_f64(a1), MSA_TPV_REINTERPRET(v2i64, msa_cgtq_f64(a1, a.val))), msa_dupq_n_s64(0)));
    }

    inline v_int32x4 v_ceil(const v_float64x2 &a) {
        v2f64 a1 = msa_cvtrintq_f64(a.val);
        return v_int32x4(
                msa_pack_s64(msa_subq_s64(msa_cvttruncq_s64_f64(a1), MSA_TPV_REINTERPRET(v2i64, msa_cgtq_f64(a.val, a1))), msa_dupq_n_s64(0)));
    }

 ...
 */
    ...
    public:
        ...
        alignCrop(InputArray src_img, InputArray face_box, OutputArray aligned_img) const = 0;
         ...
         */
        CV_WRAP virtual double match(InputArray _face_feature1, InputArray _face_feature2,
                                     int dis_type = FaceRecognizerSF::FR_COSINE) const = 0;
         ...
         *  @param target_id the id of target device
         */
        CV_WRAP static Ptr <FaceRecognizerSF>
        create(const String &model, const String &config, int backend_id = 0, int target_id = 0);
    };

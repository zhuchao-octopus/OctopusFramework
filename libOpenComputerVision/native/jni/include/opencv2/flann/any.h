...
namespace cvflann
                ...
                namespace anyimpl
        {
            ...
            struct small_any_policy CV_FINAL : typed_base_any_policy<T>
            {
                ...
                {}
                virtual
                void copy_from_value(void const *src, void **dest)
                CV_OVERRIDE
                {
                    new(dest)
                ...
                virtual
                void clone(void *const *src, void **dest)
                CV_OVERRIDE
                { *dest = *src; }
                virtual
                void move(void *const *src, void **dest)
                CV_OVERRIDE
                { *dest = *src; }
                virtual
                void *get_value(void **src)
                CV_OVERRIDE
                { return reinterpret_cast<void *>(src); }
                virtual
                const void *get_value(void *const *src)
                CV_OVERRIDE
                { return reinterpret_cast<const void *>(src); }
                virtual
                void print(std::ostream
                &out,
                void *const *src) CV_OVERRIDE
            ...
            template<>
            inline
            void big_any_policy<flann_centers_init_t>::print(std::ostream
            &out,
            void *const *src)
            {
                out <<
                int (*reinterpret_cast<flann_centers_init_t const *>(
                *src));
            }

            template<>
            inline
            void big_any_policy<flann_algorithm_t>::print(std::ostream
            &out,
            void *const *src)
            {
                out <<
                int (*reinterpret_cast<flann_algorithm_t const *>(
                *src));
            }

            template<>
            inline
            void big_any_policy<cv::String>::print(std::ostream
            &out,
            void *const *src)
            {
...
#undef SMALL_POLICY
            ...
            SinglePolicy
            {
                ...
                const SinglePolicy
                &other);
                SinglePolicy & operator =(const SinglePolicy
                &other);
...
/// This function will return a different policy for each type.
            ...
            base_any_policy *SinglePolicy<T>::get_policy() {
                static typename choose_policy<T>::type
                policy;
                return &policy;
            }

 ...
 */
JNIEXPORT jobject JNICALL Java_android_serialport_SerialPort_open(JNIEnv *, jobject, jstring, jint, jint, jint, jint, jint);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_android_serialport_SerialPort_close(JNIEnv *, jobject);

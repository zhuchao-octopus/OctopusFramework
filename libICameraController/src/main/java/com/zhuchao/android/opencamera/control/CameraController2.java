package com.zhuchao.android.opencamera.control;
...
import com.zhuchao.android.opencamera.HDRProcessor;
...
public class CameraController2 extends CameraController {
    ...
    private final static float[] jtvideo_values_base = new float[]{0.00f, 0.00f, 0.01f, 0.055f, 0.02f, 0.1f, 0.05f, 0.21f, 0.09f, 0.31f, 0.13f, 0.38f, 0.18f, 0.45f, 0.28f, 0.57f, 0.35f, 0.64f, 0.45f, 0.72f, 0.51f, 0.76f, 0.60f, 0.82f, 0.67f, 0.86f, 0.77f, 0.91f, 0.88f, 0.96f, 0.97f, 0.99f, 1.00f, 1.00f};
    private final float[] jtvideo_values;
    private final static float[] jtlog_values_base = new float[]{0.00f, 0.00f, 0.01f, 0.07f, 0.03f, 0.17f, 0.05f, 0.25f, 0.07f, 0.31f, 0.09f, 0.36f, 0.13f, 0.44f, 0.18f, 0.51f, 0.24f, 0.57f, 0.31f, 0.64f, 0.38f, 0.70f, 0.46f, 0.76f, 0.58f, 0.83f, 0.70f, 0.89f, 0.86f, 0.95f, 0.99f, 0.99f, 1.00f, 1.00f};
    private final float[] jtlog_values;
    private final static float[] jtlog2_values_base = new float[]{0.00f, 0.00f, 0.01f, 0.09f, 0.03f, 0.23f, 0.07f, 0.37f, 0.12f, 0.48f, 0.17f, 0.56f, 0.25f, 0.64f, 0.32f, 0.70f, 0.39f, 0.75f, 0.50f, 0.81f, 0.59f, 0.85f, 0.66f, 0.88f, 0.72f, 0.9f, 0.78f, 0.92f, 0.88f, 0.95f, 0.92f, 0.96f, 0.99f, 0.98f, 1.00f, 1.00f};
    ...
    private class CameraSettings {
        ...
        private int getExifOrientation() {
            ...
            switch ((rotation + 360) % 360) {
                case 0:
                    ...
                    break;
                case 90:
                    exif_orientation = (getFacing() == Facing.FACING_FRONT) ? ExifInterface.ORIENTATION_ROTATE_270 : ExifInterface.ORIENTATION_ROTATE_90;
                    break;
                case 180:
                    exif_orientation = ExifInterface.ORIENTATION_ROTATE_180;
                    break;
                case 270:
                    exif_orientation = (getFacing() == Facing.FACING_FRONT) ? ExifInterface.ORIENTATION_ROTATE_90 : ExifInterface.ORIENTATION_ROTATE_270;
                    break;
                default:
        ...
        private boolean setWhiteBalance(CaptureRequest.Builder builder) {
            ...
            if (white_balance == CameraMetadata.CONTROL_AWB_MODE_OFF) {
                if (MyDebug.LOG) Log.d(TAG, "setting white balance temperature: " + white_balance_temperature);
        ...
        private boolean setEdgeMode(CaptureRequest.Builder builder) {
            ...
            if (has_edge_mode) {
                if (!has_default_edge_mode) {
                    ...
                    if (MyDebug.LOG) Log.d(TAG, "default_edge_mode: " + default_edge_mode);
                }
                if (builder.get(CaptureRequest.EDGE_MODE) == null || builder.get(CaptureRequest.EDGE_MODE) != edge_mode) {
                    if (MyDebug.LOG) Log.d(TAG, "setting edge_mode: " + edge_mode);
                    builder.set(CaptureRequest.EDGE_MODE, edge_mode);
                    changed = true;
                } else {
                    if (MyDebug.LOG) Log.d(TAG, "edge_mode was already set: " + edge_mode);
                }
        ...
        private boolean setNoiseReductionMode(CaptureRequest.Builder builder) {
            ...
            if (has_noise_reduction_mode) {
                if (!has_default_noise_reduction_mode) {
                    ...
                    if (MyDebug.LOG) Log.d(TAG, "default_noise_reduction_mode: " + default_noise_reduction_mode);
                }
                if (builder.get(CaptureRequest.NOISE_REDUCTION_MODE) == null || builder.get(CaptureRequest.NOISE_REDUCTION_MODE) != noise_reduction_mode) {
                    if (MyDebug.LOG) Log.d(TAG, "setting noise_reduction_mode: " + noise_reduction_mode);
                    builder.set(CaptureRequest.NOISE_REDUCTION_MODE, noise_reduction_mode);
                    changed = true;
                } else {
                    if (MyDebug.LOG) Log.d(TAG, "noise_reduction_mode was already set: " + noise_reduction_mode);
                }
            } else if (is_samsung_s7) {
                ...
                switch (flash_value) {
                    ...
                    case "flash_red_eye":
                        ...
                        if (CameraController2.this.burst_type != BurstType.BURSTTYPE_NONE)
                            builder.set(CaptureRequest.CONTROL_AE_MODE, CameraMetadata.CONTROL_AE_MODE_ON);
                        else builder.set(CaptureRequest.CONTROL_AE_MODE, CameraMetadata.CONTROL_AE_MODE_ON_AUTO_FLASH_REDEYE);
                        builder.set(CaptureRequest.FLASH_MODE, CameraMetadata.FLASH_MODE_OFF);
                        break;
        ...
        private void setFaceDetectMode(CaptureRequest.Builder builder) {
            if (has_face_detect_mode) builder.set(CaptureRequest.STATISTICS_FACE_DETECT_MODE, face_detect_mode);
            else builder.set(CaptureRequest.STATISTICS_FACE_DETECT_MODE, CaptureRequest.STATISTICS_FACE_DETECT_MODE_OFF);
        }
        ...
        private void setStabilization(CaptureRequest.Builder builder) {
            if (MyDebug.LOG) Log.d(TAG, "setStabilization: " + video_stabilization);
            ...
            if (supports_optical_stabilization) {
                if (video_stabilization) {
                    ...
                    if (default_optical_stabilization == null) {
                        ...
                        if (MyDebug.LOG) Log.d(TAG, "default_optical_stabilization: " + default_optical_stabilization);
                    }
                    ...
                    if (builder.get(CaptureRequest.LENS_OPTICAL_STABILIZATION_MODE) != null && !builder.get(CaptureRequest.LENS_OPTICAL_STABILIZATION_MODE).equals(default_optical_stabilization)) {
                        if (MyDebug.LOG) Log.d(TAG, "set optical stabilization back to: " + default_optical_stabilization);
        ...
        private void setTonemapProfile(CaptureRequest.Builder builder) {
            ...
            if (tonemap_profile == TonemapProfile.TONEMAPPROFILE_LOG && log_profile_strength == 0.0f) have_tonemap_profile = false;
            else if (tonemap_profile == TonemapProfile.TONEMAPPROFILE_GAMMA && gamma_profile == 0.0f) have_tonemap_profile = false;
            ...
            if (have_tonemap_profile) {
                if (default_tonemap_mode == null) {
                    ...
                    if (MyDebug.LOG) Log.d(TAG, "default_tonemap_mode: " + default_tonemap_mode);
                }
                ...
                if (use_preset_curve && tonemap_profile == TonemapProfile.TONEMAPPROFILE_REC709 && Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    ...
                    if (MyDebug.LOG) Log.d(TAG, "handle via TONEMAP_MODE_CONTRAST_CURVE / TONEMAP_CURVE");
                    float[] values = null;
                    switch (tonemap_profile) {
                        case TONEMAPPROFILE_REC709:
                            // y = 4.5x if x < 0.018, else y = 1.099*x^0.45 - 0.099
                            float[] x_values = new float[]{0.0000f, 0.0667f, 0.1333f, 0.2000f, 0.2667f, 0.3333f, 0.4000f, 0.4667f, 0.5333f, 0.6000f, 0.6667f, 0.7333f, 0.8000f, 0.8667f, 0.9333f, 1.0000f};
                        ...
                        case TONEMAPPROFILE_SRGB:
                            values = new float[]{0.0000f, 0.0000f, 0.0667f, 0.2864f, 0.1333f, 0.4007f, 0.2000f, 0.4845f, 0.2667f, 0.5532f, 0.3333f, 0.6125f, 0.4000f, 0.6652f, 0.4667f, 0.7130f, 0.5333f, 0.7569f, 0.6000f, 0.7977f, 0.6667f, 0.8360f, 0.7333f, 0.8721f, 0.8000f, 0.9063f, 0.8667f, 0.9389f, 0.9333f, 0.9701f, 1.0000f, 1.0000f};
                            break;
                        ...
                        case TONEMAPPROFILE_GAMMA: {
                            ...
                            //int n_values = 32;
                            if (MyDebug.LOG) Log.d(TAG, "n_values: " + n_values);
                    ...
                    if (MyDebug.LOG) Log.d(TAG, "values: " + Arrays.toString(values));
                    if (values != null) {
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            synchronized (background_camera_lock) {
                ...
                if (burst_single_request) {
                    ...
                    if (pending_burst_images.size() >= n_burst) { // shouldn't ever be greater, but just in case
                        ...
                        if (MyDebug.LOG) Log.d(TAG, "number of burst images is now: " + pending_burst_images.size());
            ...
            synchronized (background_camera_lock) {
                if (single_burst_complete_images != null) {
                    ...
                    n_burst--;
                    if (MyDebug.LOG) Log.d(TAG, "n_burst is now " + n_burst);
                ...
                if (slow_burst_capture_requests != null) {
                    ...
                    if (burst_type != BurstType.BURSTTYPE_FOCUS) {
                        ...
                        handler.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                if (MyDebug.LOG) Log.d(TAG, "take picture after delay for next focus bracket");
                                if (camera != null && captureSession != null) { // make sure camera wasn't released in the meantime
            ...
            synchronized (background_camera_lock) {
                ...
                if (images.size() > 0) {
                    ...
                    activity.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            if (MyDebug.LOG) Log.d(TAG, "setCaptureResult UI thread call processImage()");
            ...
            synchronized (background_camera_lock) {
                ...
                if (n_burst_total == 1 && burst_type != BurstType.BURSTTYPE_CONTINUOUS) {
                    ...
                    if (pending_burst_images_raw.size() >= n_burst_raw) { // shouldn't ever be greater, but just in case
                        ...
                        if (MyDebug.LOG) Log.d(TAG, "number of raw burst images is now: " + pending_burst_images_raw.size());
                    }
                }
                // case for burst_single_request==false handled below
            }
            ...
            if (pending_raw_image != null) {
                ...
                synchronized (background_camera_lock) {
                    if (single_burst_complete_images != null) {
                        ...
                        n_burst_raw--;
                        if (MyDebug.LOG) Log.d(TAG, "n_burst_raw is now " + n_burst_raw);
                        if (burst_type == BurstType.BURSTTYPE_CONTINUOUS && !continuous_burst_requested_last_capture) {
    ...
    public CameraController2(Context context, int cameraId, final ErrorCallback preview_error_cb, final ErrorCallback camera_error_cb) throws CameraControllerException {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                if (MyDebug.LOG) Log.d(TAG, "check if camera has opened in reasonable time: " + this);
                synchronized (open_camera_lock) {
                    if (MyDebug.LOG) {
    ...
    private float[] enforceMinTonemapCurvePoints(float[] in_values) {
        ...
        if (MyDebug.LOG) Log.d(TAG, "min_points_c: " + min_points_c);
    ...
    public CameraFeatures getCameraFeatures() throws CameraControllerException {
        ...
        if (camera_features.supports_face_detection) {
            ...
            if (MyDebug.LOG) Log.d(TAG, "has_face_priority: " + has_face_priority);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (camera_picture_sizes_hires != null) {
                for (android.util.Size camera_size : camera_picture_sizes_hires) {
                    if (MyDebug.LOG) Log.d(TAG, "high resolution picture size: " + camera_size.getWidth() + " x " + camera_size.getHeight());
        ...
        if (camera_picture_sizes == null) {
            ...
            for (android.util.Size camera_size : camera_picture_sizes) {
                if (MyDebug.LOG) Log.d(TAG, "picture size: " + camera_size.getWidth() + " x " + camera_size.getHeight());
        ...
        if (capabilities_raw) {
            ...
            if (raw_camera_picture_sizes == null) {
                ...
                if (raw_size == null) {
                    ...
                    if (MyDebug.LOG) Log.d(TAG, "raw supported, raw size: " + raw_size.getWidth() + " x " + raw_size.getHeight());
        ...
        if (camera_video_sizes == null) {
            ...
            for (android.util.Size camera_size : camera_video_sizes) {
                if (camera_size.getWidth() > 4096 || camera_size.getHeight() > 2160) continue; // Nexus 6 returns these, even though not supported?!
        ...
        if (capabilities_high_speed_video) {
            ...
            for (android.util.Size camera_size : camera_video_sizes_high_speed) {
                ...
                if (camera_size.getWidth() > 4096 || camera_size.getHeight() > 2160) continue; // just in case? see above
        ...
        if (camera_preview_sizes == null) {
            ...
            for (android.util.Size camera_size : camera_preview_sizes) {
                if (MyDebug.LOG) Log.d(TAG, "preview size: " + camera_size.getWidth() + " x " + camera_size.getHeight());
        ...
        if (minimum_focus_distance != null) {
            ...
            if (MyDebug.LOG) Log.d(TAG, "minimum_focus_distance: " + camera_features.minimum_focus_distance);
        } else {
        ...
        if (camera_features.supported_focus_values != null) {
            ...
            if (MyDebug.LOG) Log.d(TAG, "initial_focus_mode: " + initial_focus_mode);
        } else {
        ...
        if (MyDebug.LOG) Log.d(TAG, "is_optical_stabilization_supported: " + camera_features.is_optical_stabilization_supported);
        ...
        if (MyDebug.LOG) Log.d(TAG, "is_video_stabilization_supported: " + camera_features.is_video_stabilization_supported);
            ...
            if (iso_range != null) {
                ...
                if (exposure_time_range != null) {
                    ...
                    if (is_samsung_galaxy_s && Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                        ...
                        // going above this!
                        if (MyDebug.LOG) Log.d(TAG, "boost max_exposure_time, was: " + max_exposure_time);
        ...
        if (capabilities_manual_post_processing) {
            ...
            if (tonemap_max_curve_points != null) {
                if (MyDebug.LOG) Log.d(TAG, "tonemap_max_curve_points: " + tonemap_max_curve_points);
                ...
                camera_features.supports_tonemap_curve = tonemap_max_curve_points >= tonemap_log_max_curve_points_c && tonemap_max_curve_points >= jtvideo_values.length / 2 && tonemap_max_curve_points >= jtlog_values.length / 2 && tonemap_max_curve_points >= jtlog2_values.length / 2;
            } else {
                if (MyDebug.LOG) Log.d(TAG, "tonemap_max_curve_points is null");
            }
        }
        if (MyDebug.LOG) Log.d(TAG, "supports_tonemap_curve?: " + camera_features.supports_tonemap_curve);
        ...
        if (MyDebug.LOG) Log.d(TAG, "apertures: " + Arrays.toString(apertures));
    ...
    public SupportedValues setWhiteBalance(String value) {
        ...
        }
        {
            ...
            if (has_auto) values.add(0, WHITE_BALANCE_DEFAULT);
        }
    ...
    private String convertAntiBanding(int value2) {
        ...
        switch (value2) {
            ...
            case CameraMetadata.CONTROL_AE_ANTIBANDING_MODE_OFF:
                ...
                break;
            default:
                if (MyDebug.LOG) Log.d(TAG, "unknown antibanding: " + value2);
                value = null;
                break;
        }
        return value;
    ...
    private String convertEdgeMode(int value2) {
        ...
        switch (value2) {
            ...
            case CameraMetadata.EDGE_MODE_ZERO_SHUTTER_LAG:
                ...
                break;
            default:
                if (MyDebug.LOG) Log.d(TAG, "unknown edge_mode: " + value2);
                value = null;
                break;
        }
        return value;
    ...
    private String convertNoiseReductionMode(int value2) {
        ...
        switch (value2) {
            ...
            case CameraMetadata.NOISE_REDUCTION_MODE_ZERO_SHUTTER_LAG:
                ...
                break;
            default:
                if (MyDebug.LOG) Log.d(TAG, "unknown noise_reduction_mode: " + value2);
                value = null;
                break;
        }
        return value;
    ...
    public void setManualISO(boolean manual_iso, int iso) {
        ...
        try {
            if (manual_iso) {
                ...
                if (MyDebug.LOG) Log.d(TAG, "iso range from " + iso_range.getLower() + " to " + iso_range.getUpper());
    ...
    public void setVideoHighSpeed(boolean want_video_high_speed) {
        if (MyDebug.LOG) Log.d(TAG, "setVideoHighSpeed: " + want_video_high_speed);
        if (camera == null) {
            if (MyDebug.LOG) Log.e(TAG, "no camera");
            return;
        }
    ...
    public void setBurstType(BurstType burst_type) {
        if (MyDebug.LOG) Log.d(TAG, "setBurstType: " + burst_type);
        if (camera == null) {
            if (MyDebug.LOG) Log.e(TAG, "no camera");
            return;
        }
    ...
    public boolean isCapturingBurst() {
        if (!isBurstOrExpo()) return false;
        if (burst_type == BurstType.BURSTTYPE_CONTINUOUS) return continuous_burst_in_progress || n_burst > 0 || n_burst_raw > 0;
    ...
    public int getBurstTotal() {
        if (burst_type == BurstType.BURSTTYPE_CONTINUOUS) return 0; // total burst size is unknown
    ...
    public void setOptimiseAEForDRO(boolean optimise_ae_for_dro) {
        ...
        if (is_oneplus) {
            ...
            this.optimise_ae_for_dro = false;
            if (MyDebug.LOG) Log.d(TAG, "don't modify ae for Samsung");
        } else {
    ...
    public void setBurstNImages(int burst_requested_n_images) {
        if (MyDebug.LOG) Log.d(TAG, "setBurstNImages: " + burst_requested_n_images);
    ...
    private void checkImagesCompleted() {
        ...
        synchronized (background_camera_lock) {
            if (!done_all_captures) {
                ...
                if (MyDebug.LOG) Log.d(TAG, "jpeg callback already done, can now call pending raw callback");
        ...
        if (completed) {
            ...
            cb.onCompleted();
            synchronized (background_camera_lock) {
                if (burst_type == BurstType.BURSTTYPE_FOCUS) focus_bracketing_in_progress = false;
            }
        }
    }
    ...
    public void setVideoStabilization(boolean enabled) {
        if (MyDebug.LOG) Log.d(TAG, "setVideoStabilization: " + enabled);
    ...
    public void setTonemapProfile(TonemapProfile tonemap_profile, float log_profile_strength, float gamma) {
        ...
        if (camera_settings.tonemap_profile == tonemap_profile && camera_settings.log_profile_strength == log_profile_strength && camera_settings.gamma_profile == gamma)
            return; // no change

        camera_settings.tonemap_profile = tonemap_profile;

        if (tonemap_profile == TonemapProfile.TONEMAPPROFILE_LOG) camera_settings.log_profile_strength = log_profile_strength;
        else camera_settings.log_profile_strength = 0.0f;

        if (tonemap_profile == TonemapProfile.TONEMAPPROFILE_GAMMA) camera_settings.gamma_profile = gamma;
        else camera_settings.gamma_profile = 0.0f;
    ...
    public void setPreviewFpsRange(int min, int max) {
        if (MyDebug.LOG) Log.d(TAG, "setPreviewFpsRange: " + min + "-" + max);
    ...
    public List<int[]> getSupportedPreviewFpsRange() {
        ...
        if (MyDebug.LOG) Log.d(TAG, "   using " + (want_video_high_speed ? "high speed" : "ae") + " preview fps ranges");
    ...
    public String getFocusValue() {
        ...
        if (focus_mode == null) focus_mode = CaptureRequest.CONTROL_AF_MODE_AUTO;
    ...
    public void setFocusBracketingNImages(int n_images) {
        if (MyDebug.LOG) Log.d(TAG, "setFocusBracketingNImages: " + n_images);
        this.focus_bracketing_n_images = n_images;
    }

    @Override
    public void setFocusBracketingAddInfinity(boolean focus_bracketing_add_infinity) {
        if (MyDebug.LOG) Log.d(TAG, "setFocusBracketingAddInfinity: " + focus_bracketing_add_infinity);
    ...
    public void setFocusBracketingSourceDistance(float focus_bracketing_source_distance) {
        if (MyDebug.LOG) Log.d(TAG, "setFocusBracketingSourceDistance: " + focus_bracketing_source_distance);
    ...
    public void setFocusBracketingTargetDistance(float focus_bracketing_target_distance) {
        if (MyDebug.LOG) Log.d(TAG, "setFocusBracketingTargetDistance: " + focus_bracketing_target_distance);
    ...
    private void updateUseFakePrecaptureMode(String flash_value) {
        ...
        } else if (burst_type != BurstType.BURSTTYPE_NONE) use_fake_precapture_mode = true;
        else if (camera_settings.has_iso) use_fake_precapture_mode = true;
        else {
    ...
    public boolean getAutoWhiteBalanceLock() {
        if (previewBuilder.get(CaptureRequest.CONTROL_AWB_LOCK) == null) return false;
    ...
    public boolean supportsAutoFocus() {
        ...
        Integer focus_mode = previewBuilder.get(CaptureRequest.CONTROL_AF_MODE);
        if (focus_mode == null) return false;
        if (focus_mode == CaptureRequest.CONTROL_AF_MODE_AUTO || focus_mode == CaptureRequest.CONTROL_AF_MODE_MACRO) return true;
        return false;
    }
    ...
    public void updatePreviewTexture() {
        ...
        if (texture != null) {
            if (preview_width == 0 || preview_height == 0) {
                ...
                if (MyDebug.LOG) Log.d(TAG, "preview size: " + preview_width + " x " + preview_height);
    ...
    private void createCaptureSession(final MediaRecorder video_recorder, boolean want_photo_video_recording) throws CameraControllerException {
        ...
        try {
            ...
            if (texture != null) {
                ...
                if (MyDebug.LOG) Log.d(TAG, "set size of preview texture: " + preview_width + " x " + preview_height);
                if (preview_width == 0 || preview_height == 0) {
            ...
            if (video_recorder != null) {
                ...
                if (MyDebug.LOG) Log.d(TAG, "picture size: " + imageReader.getWidth() + " x " + imageReader.getHeight());
            }
            /*if( MyDebug.LOG )
            Log.d(TAG, "preview size: " + previewImageReader.getWidth() + " x " + previewImageReader.getHeight());*/
            if (MyDebug.LOG) Log.d(TAG, "set preview size: " + this.preview_width + " x " + this.preview_height);

            synchronized (background_camera_lock) {
                if (video_recorder != null) video_recorder_surface = video_recorder.getSurface();
                else video_recorder_surface = null;
                if (MyDebug.LOG) Log.d(TAG, "video_recorder_surface: " + video_recorder_surface);
            }
    ...
    public void startPreview() throws CameraControllerException {
        ...
        if (!camera_settings.has_af_mode && initial_focus_mode != null) {
            if (MyDebug.LOG) Log.d(TAG, "user didn't specify focus, so set to: " + initial_focus_mode);
    ...
    public void autoFocus(final AutoFocusCallback cb, boolean capture_follows_autofocus_hint) {
        ...
        synchronized (background_camera_lock) {
            ...
            Integer focus_mode = previewBuilder.get(CaptureRequest.CONTROL_AF_MODE);
            if (MyDebug.LOG) Log.d(TAG, "focus mode: " + (focus_mode == null ? "null" : focus_mode));
            if (focus_mode == null) {
    ...
    private void setManualExposureTime(CaptureRequest.Builder stillBuilder, long exposure_time, boolean set_iso, int new_iso) {
        if (MyDebug.LOG) Log.d(TAG, "setManualExposureTime: " + exposure_time);
        Range<Integer> iso_range = characteristics.get(CameraCharacteristics.SENSOR_INFO_SENSITIVITY_RANGE); // may be null on some devices
        if (this.supports_exposure_time && iso_range != null) {
            ...
            stillBuilder.set(CaptureRequest.CONTROL_AE_MODE, CameraMetadata.CONTROL_AE_MODE_OFF);
            {
                // set ISO
                int iso = 800;
                if (set_iso) iso = new_iso;
                else if (capture_result_has_iso) iso = capture_result_iso;
            ...
            if (capture_result_has_frame_duration) stillBuilder.set(CaptureRequest.SENSOR_FRAME_DURATION, capture_result_frame_duration);
        ...
        synchronized (background_camera_lock) {
            ...
            try {
                ...
                if (use_fake_precapture_mode && fake_precapture_torch_performed) {
                    ...
                    if (!camera_settings.has_iso) stillBuilder.set(CaptureRequest.CONTROL_AE_MODE, CameraMetadata.CONTROL_AE_MODE_ON);
            ...
            synchronized (background_camera_lock) {
                ...
                if (test_release_during_photo) {
                    ...
                    activity.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            if (MyDebug.LOG) Log.d(TAG, "test UI thread call release()");
                            release();
                        }
                    });
                    try {
    ...
    private void takePictureBurstBracketing() {
        ...
        synchronized (background_camera_lock) {
            ...
            try {
                ...
                stillBuilder.addTarget(imageReader.getSurface());
                if (raw_todo) stillBuilder.addTarget(imageReaderRaw.getSurface());
                ...
                requests.add( stillBuilder.build() );*/
                    ...
                    if (iso_range == null) {
                        ...
                        if (camera_settings.has_iso) iso = camera_settings.iso;
                        else if (capture_result_has_iso) iso = capture_result_iso;
                        // see https://sourceforge.net/p/opencamera/tickets/321/ - some devices may have auto ISO that's
                        // outside of the allowed manual iso range!
                        iso = Math.max(iso, iso_range.getLower());
                    ...
                    for (int i = 0; i < n_half_images; i++) {
                        ...
                        if (supports_exposure_time) {
                            ...
                            if (i == n_half_images - 1) {
                                ...
                                if (MyDebug.LOG) Log.d(TAG, "set RequestTagType.CAPTURE for last burst request");
                                stillBuilder.setTag(new RequestTagObject(RequestTagType.CAPTURE));
                            } else {
                                stillBuilder.setTag(new RequestTagObject(RequestTagType.CAPTURE_BURST_IN_PROGRESS));
                            }
                        ...
                        if (HDRProcessor.sceneIsLowLight(capture_result_iso, capture_result_exposure_time)) {
                            ...
                            if (!camera_settings.has_iso && !is_oneplus) {
                                ...
                                if (capture_result_exposure_time < exposure_time) {
                                    if (MyDebug.LOG) Log.d(TAG, "also set long exposure time");
                                    modified_from_camera_settings = true;
                                    ...
                                    int new_iso = 0;
                                    {
                                        ...
                                        if (MyDebug.LOG) Log.d(TAG, "... and set iso to " + new_iso);
                                    }
                ...
                try {
                    ...
                    if (burst_type == BurstType.BURSTTYPE_CONTINUOUS) {
                        if (MyDebug.LOG) {
                            ...
                            if (!continuous_burst_in_progress) Log.d(TAG, "    last continuous capture");
                        }
                            ...
                            public void run() {
                                ...
                                synchronized (background_camera_lock) {
                                    ...
                                    try {
                                        ...
                                        n_remaining--;
                                        if (MyDebug.LOG) Log.d(TAG, "takePictureBurst n_remaining: " + n_remaining);
                                        if (n_remaining > 0) {
    ...
    private void runPrecapture() {
        ...
        synchronized (background_camera_lock) {
            if (MyDebug.LOG) {
                if (use_fake_precapture_mode) Log.e(TAG, "shouldn't be doing standard precapture when use_fake_precapture_mode is true!");
    ...
    private void runFakePrecapture() {
        ...
        synchronized (background_camera_lock) {
            switch (camera_settings.flash_value) {
                ...
                case "flash_frontscreen_on":
                    ...
                    break;
                default:
                    if (MyDebug.LOG) Log.e(TAG, "runFakePrecapture called with unexpected flash value: " + camera_settings.flash_value);
                    break;
            }
        }
        ...
        if (turn_frontscreen_on) {
            if (picture_cb != null) {
                ...
                if (MyDebug.LOG) Log.e(TAG, "can't request screen turn on for frontscreen flash, as no picture_cb");
            }
        }
...

            {
                ...
                if (camera_settings.flash_value.equals("flash_off") || camera_settings.flash_value.equals("flash_torch") || camera_settings.flash_value.equals("flash_frontscreen_torch")) {
                    ...
                    if (auto_flash && !fireAutoFlash()) {
                        if (MyDebug.LOG) Log.d(TAG, "fake precapture flash auto: seems bright enough to not need flash");
                        call_takePictureAfterPrecapture = true;
                    } else if (flash_mode != null && flash_mode == CameraMetadata.FLASH_MODE_TORCH) {
                        if (MyDebug.LOG) Log.d(TAG, "fake precapture flash: torch already on (presumably from autofocus)");
    ...
    public boolean needsFrontScreenFlash() {
        return camera_settings.flash_value.equals("flash_frontscreen_on") || (camera_settings.flash_value.equals("flash_frontscreen_auto") && fireAutoFlashFrontScreen());
    }
    ...
    private final CameraCaptureSession.CaptureCallback previewCaptureCallback = new CameraCaptureSession.CaptureCallback() {
        ...
        private void updateCachedAECaptureStatus(CaptureResult result) {
            ...
            if (use_fake_precapture_mode && (fake_precapture_torch_focus_performed || fake_precapture_torch_performed) && flash_mode != null && flash_mode == CameraMetadata.FLASH_MODE_TORCH) {
                ...
                if (MyDebug.LOG) Log.d(TAG, "CONTROL_AE_STATE changed from " + capture_result_ae + " to " + ae_state);
            ...
            if (af_state != null && af_state == CaptureResult.CONTROL_AF_STATE_PASSIVE_SCAN) {
                ...
                if (autofocus_cb != null && (!do_af_trigger_for_continuous || use_fake_precapture_mode) && focusIsContinuous()) {
                    ...
                    if (focus_mode != null && focus_mode == CaptureRequest.CONTROL_AF_MODE_CONTINUOUS_PICTURE) {
                        if (MyDebug.LOG) Log.d(TAG, "call autofocus callback, as continuous mode and not focusing: " + af_state);
                    ...
                    if (af_state == CaptureResult.CONTROL_AF_STATE_FOCUSED_LOCKED || af_state == CaptureResult.CONTROL_AF_STATE_NOT_FOCUSED_LOCKED /*||
                        ...
                        if (use_fake_precapture_mode && fake_precapture_torch_focus_performed) {
                            ...
                            if (!capture_follows_autofocus_hint) {
                                ...
                                if (MyDebug.LOG) Log.d(TAG, "turn off torch after focus (fake precapture code)");
                                ...
                                if (MyDebug.LOG) Log.d(TAG, "torch was enabled for autofocus, leave it on for capture (fake precapture code)");
                            }
                        }
                        if (autofocus_cb != null) {
                            autofocus_cb.onAutoFocus(focus_success);
        ...
        private void handleCaptureCompleted(CaptureResult result) {
            ...
            activity.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    if (MyDebug.LOG) Log.d(TAG, "processCompleted UI thread call checkImagesCompleted()");
                    synchronized (background_camera_lock) {
                        done_all_captures = true;
                        if (MyDebug.LOG) Log.d(TAG, "done all captures");
                    }
                    checkImagesCompleted();
                }
            });

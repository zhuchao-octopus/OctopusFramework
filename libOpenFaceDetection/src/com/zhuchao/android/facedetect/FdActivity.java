package com.zhuchao.android.facedetect;
            ...
            public void onClick(View v) {
                if(mRgba != null) {
                    if(!mRgba.empty()) {
                        ...
                        String savepath=sdDir + "/Pictures/";
                        File f=new File(savepath);
                        if(!f.exists()){
                            f.mkdirs();
                        }
                        String filePath = sdDir + "/Pictures/" + filename + ".png";
                        Imgcodecs.imwrite(filePath, inter);
                        Toast.makeText(FdActivity.this, "图片保存到: "+ filePath, Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });

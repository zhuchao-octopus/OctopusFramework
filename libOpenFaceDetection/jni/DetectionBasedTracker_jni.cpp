...
Java_com_zhuchao_android_facedetect_DetectionBasedTracker_nativeCreateObject(JNIEnv *jenv,
                                                                             jclass clazz,
                                                                             jstring cascade_name,
                                                                             jint min_face_size) {
    {
        LOGD("Java_org_opencv_samples_facedetect_DetectionBasedTracker_nativeCreateObject enter");
        const char* jnamestr = jenv->GetStringUTFChars(cascade_name, NULL);
...
Java_com_zhuchao_android_facedetect_DetectionBasedTracker_nativeDestroyObject(JNIEnv *jenv,
                                                                              jclass clazz,
                                                                              jlong thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_zhuchao_android_facedetect_DetectionBasedTracker_nativeStart(JNIEnv *jenv, jclass clazz,
                                                                      jlong thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_zhuchao_android_facedetect_DetectionBasedTracker_nativeStop(JNIEnv *jenv, jclass clazz,
                                                                     jlong thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_zhuchao_android_facedetect_DetectionBasedTracker_nativeSetFaceSize(JNIEnv *jenv,
                                                                            jclass clazz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_zhuchao_android_facedetect_DetectionBasedTracker_nativeDetect(JNIEnv *jenv, jclass clazz,
                                                                       jlong thiz,
                                                                       jlong input_image,
                                                                       jlong faces) {

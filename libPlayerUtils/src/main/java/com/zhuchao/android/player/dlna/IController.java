...
public interface IController {
     ...
     *
     * @param device         The device be controlled.
     * @param targetPosition Target position we want to set.
     * @return
     */
     ...
     *
     * @param device      The device be controlled.
     * @param targetValue 1 is that want mute, 0 if you want make it off of mute.
     ...
     *
     * @param device The device be controlled.
     * @param value  Target voice want be set.
     * @return
     */
